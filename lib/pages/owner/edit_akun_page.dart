...
class EditAkunOwnerPage extends StatefulWidget {
  const EditAkunOwnerPage({super.key});

  @override
  State<EditAkunOwnerPage> createState() => _EditAkunOwnerPageState();
}

class _EditAkunOwnerPageState extends State<EditAkunOwnerPage> {
  ...
  Future<void> _simpan() async {
    ...
    OwnerAuth.currentOwner?['nama_lengkap'] = _namaController.text.trim();
    OwnerAuth.currentOwner?['email'] = _emailController.text.trim();
    OwnerAuth.currentOwner?['no_hp'] = _hpController.text.trim();
    OwnerAuth.currentOwner?['kota_asal'] = _kotaController.text.trim();
